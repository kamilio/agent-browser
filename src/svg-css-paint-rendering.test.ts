...
it.each([
	...
	'<rect width="4" height="2" clip-path="url(https://example.invalid/external.svg#clip)" style="fill:red"/>',
	'<rect width="4" height="2" style="fill:red;clip-path:url(https://example.invalid/external.svg#clip)"/>',
