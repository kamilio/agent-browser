...
async function fixture(css = "", attributes = "", extra = "") {
	...
	const bodies = new Map([
		[
			...
			`<!doctype html><title>Start</title><style>html,body{margin:0;padding:0;font-family:'Agent Mono';font-size:8px;line-height:8px}main{width:100px;word-spacing:4px}${css}</style><main><a id="target" href="/next" ${attributes}>A B</a></main>${extra}`,
		],
		[
